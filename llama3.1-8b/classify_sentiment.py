...
def classify_comment(args):
    ...
    prompt = (
        ...
        "2. performance: Does this comment discuss the athlete's results, technique, "
        "race times, medals, records, or competitive achievements in speed skating? (true/false)\n"
        "3. negative: Is the tone of this comment negative or critical toward the athlete "
